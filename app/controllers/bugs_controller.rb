...
class BugsController < ApplicationController
  ...
  def show
    ...
    @new_issue_url = Service::JIRA.new_issue_link(summary:     t('controllers.bugs.show.jira_link.summary',
                                                                 ...
                                                                 file_name:  @bug.displayable_file? ? File.basename(@bug.file) : t('controllers.bugs.show.jira_link.not_applicable'),
                                                                 line:       @bug.displayable_file? ? @bug.line : t('controllers.bugs.show.jira_link.not_applicable'),
                                                                 locale:     @bug.environment.project.locale),
                                                  environment: @environment.name,
                                                  description: t('controllers.bugs.show.jira_link.description',
                                                                 class_name: @bug.class_name,
                                                                 file:       @bug.displayable_file? ? @bug.file : t('controllers.bugs.show.jira_link.not_applicable'),
                                                                 line:       @bug.displayable_file? ? @bug.line : t('controllers.bugs.show.jira_link.not_applicable'),
